...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.0.1 Pro", e = layui.jquery, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
        o = "layim-this", r = 20, d = {}, c = function () {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (a[0]) {
            var s = w.find(".layim-chat-list"), o = s.find(".layim-chatlist-" + i.type + i.id),
                r = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), c = a.children(".layim-chat-box");
            return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (r || w.css("width", 800), s.css({height: w.height()}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), N()), M(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || P(), R(i), Z(), C
        }
        l.first = !0;
        var u = C = t.open({
            type: 1,
            ...
            full: function (i) {
                t.style(u, {width: "100%", height: "100%"}, !0), N()
            },
            resizing: N,
            restore: N,
            min: function () {
        ...
        var a = i || O().data, n = layui.layim.cache().base;
        ...
        var n = i.index() === -1 ? 0 : i.index(), l = ".layim-chat", r = w.find(l).eq(n),
        ...
        var i = O(), a = j.message[i.data.type + i.data.id];
        ...
        var i = {
            ...
            mine: !0
        }, a = O(), e = a.elem.find(".layim-chat-main ul"), l = j.base.maxLength || 3e3;
        ...
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || B(i), K = JSON.parse(JSON.stringify(i)), j.base.voice && G(), !w && i.content || l === -1) {
            ...
            }), A({name: "收到新消息", avatar: t.avatar || i.avatar, anim: 6})
        }
        if (w) {
            var r = O();
            ...
            var d = w.find(".layim-chat").eq(l), c = d.find(".layim-chat-main ul");
        ...
        var i = layui.data("layim")[j.mine.id] || {}, a = O(), e = i.chatlog || {},
        ...
        var i = O(), a = i.elem.find(".layim-chat-main"), e = a.find("ul"), t = e.find("li").length;
        if (t >= r) {
        ...
        status: function (i, a) {
            ...
            if ("show" === n) X(a), i.next().show().addClass(ai), e(document).off("click", t).on("click", t); else {
                var l = i.parent().prev();
            ...
            var a = x.find(".layui-layim-search"), e = x.find("#layui-layim-search"), t = a.find("input"),
                n = function (i) {
                    ...
                    if ("" === a) ei.tab(0 | ei.tab.index); else {
            ...
            t.alert("123： " + a + '<br>版权所有：<a href="http://layim.layui.com" target="_blank">layim.layui.com</a>', {
                title: "关于 LayIM",
                shade: !1
            })
        }, setSkin: function (i) {
            ...
            i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ei.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                success: function (a) {
                    var t = j.base.members || {}, n = O(), s = a.find(".layim-members-list"), o = "", r = {},
                        c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"),
                    ...
                    c && s.css({width: e(window).width() - 22 - (u || 200)}), t.data = e.extend(t.data, {id: n.data.id}), S(t, function (a) {
                        layui.each(a.list, function (i, a) {
                            ...
                            var i = e(this).data("uid"), a = r[i];
                            T({name: a.username, type: "friend", avatar: a.avatar, id: a.id}), l()
            ...
            var t = ei.setSend.box = i.siblings(".layim-menu-box"), n = i.attr("lay-type");
            if ("show" === n) X(a), t.show().addClass(ai), e(document).off("click", ei.setSendHide).on("click", ei.setSendHide); else {
                i.addClass(o).siblings().removeClass(o);
                var l = layui.data("layim")[j.mine.id] || {};
                l.sendHotKey = n, layui.data("layim", {key: j.mine.id, value: l}), ei.setSendHide(a, i.parent())
            }
            ...
            var a = i.data("type") || "images", e = {images: "uploadImage", file: "uploadFile"}, n = O(),
                l = j.base[e[a]] || {};
            layui.upload({
                url: l.url || "",
                method: l.type,
            ...
            var n = layui.data("layim")[j.mine.id] || {}, l = i.parent(), s = i.data("type"),
                o = x.find(".layim-list-history"), r = '<li class="layim-null">暂无历史会话</li>';
            if ("one" === s) {
                var d = n.history;

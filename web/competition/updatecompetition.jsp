            ...
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                ...
                <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
                    <div class="layui-tab-item layui-show">
                        <form action="/bg/upData" method="post">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-verify="required" name="level" lay-filter="column">
                                            ...
                                            <option value="1" ${obj.level == '1' ? "selected":''} >
                                                简单
                                            </option>
                                            <option value="2" ${obj.level == '2' ? "selected":''} >
                                                中等
                                            </option>
                                            <option value="3" ${obj.level == '3' ? "selected":''} >
                                                困难
                                            </option>
                            ...
                            <div class="layui-form-item layui-form-text">
                                <div class="layui-input-block ">
                                    <textarea id="L_content" name="content" required lay-verify="required"
                                              ...
                                              style="height: 260px;" placeholder="请输入">${obj.content}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline ">
                                    <input type="text" id="L_vercode" name="answer" required lay-verify="required"
                                           placeholder="请提交正确的问题答案" autocomplete="off" class="layui-input" value="${obj.answer}">
                                </div>

                            </div>

                            <div class="layui-form-item">
                                <input type="submit" class="layui-btn layui-bg-black" lay-filter="*" value="更新"/>
                            </div>
